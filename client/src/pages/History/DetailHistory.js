...
import { HistoryAction, HistoryDetailAction } from '../../redux/action/orderAction';
...
export default function DetailHistory (props) {
    ...
    console.log(id);
    const { historyDetail } = useSelector(root => root.orderReducer)
    useEffect(() => {
        const action = HistoryDetailAction(id);
        dispatch(action)
    }, []);
                ...
                <main className="main">
                    <div className="page-header text-center" style={{ backgroundImage: 'url("assets/images/page-header-bg.jpg")' }}>
                        <div className="container">
                            <h1 className="page-title">History Item<span>Shop</span></h1>
                        </div>{/* End .container */}
                    </div>{/* End .page-header */}
                    <nav aria-label="breadcrumb" className="breadcrumb-nav">
                        <div className="container">
                            <ol className="breadcrumb">
                                ...
                                <li className="breadcrumb-item active" aria-current="page">History Order Item</li>
                            </ol>
                        </div>{/* End .container */}
                                            ...
                                            <tbody>
                                                {historyDetail?.map((item, index) => {
                                                    return <tr key={index}>
                                                        <td className="product-col">
                                                            <div className="product">
                                                                <figure className="product-media">
                                                                    <div>
                                                                        <img src={item.phone?.image_url} alt="Product image" />
                                                                    </div>
                                                                </figure>
                                                        ...
                                                        <td className="price-col">{item.quantity}</td>
