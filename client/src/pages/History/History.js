...
import { HistoryAction } from '../../redux/action/orderAction';
                    ...
                    <main className="main">
                        <div className="page-header text-center" style={{ backgroundImage: 'url("assets/images/page-header-bg.jpg")' }}>
                            <div className="container">
                                <h1 className="page-title">History<span>Shop</span></h1>
                            </div>{/* End .container */}
                        </div>{/* End .page-header */}
                        <nav aria-label="breadcrumb" className="breadcrumb-nav">
                            <div className="container">
                                <ol className="breadcrumb">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">History Order</li>
                                </ol>
                            </div>{/* End .container */}
                                                ...
                                                <tbody>
                                                    {history?.map((item, index) => {
                                                        return <tr key={index}>
                                                            ...
                                                            <td className="price-col">{item.customer_name}</td>
                                                            <td className="price-col">{item.customer_phone}</td>
                                                            <td className="price-col">{item.total_price}</td>

                                                            <td className="remove-col"><NavLink className="btn-remove" to={`/detailhistory/${item.id}`}>Chi Tiết</NavLink></td>
                                                        </tr>
                                                    })}
